...
<body>
   ...
   <div class="main">
       ...
       if(isset($_GET["fallo"]) && $_GET["fallo"] == 'true')
       {
          ...
          <div id='hola'>Usuario o contraseña invalidos </div>";
       }
        ?>
         <br>
        ...
        <br>
        <p>¿Olvidó su contraseña? <a href="recuperarcontraseña.php">Recuperar</a><p> 
        <br>
        <p>2022 - City Coffe. Todos los derechos reservados <p> 
    </div>

       <!-- <div class="main">
            <form action="logica/loguear.php" method="POST "id="formlg" >
              <input type="text" name="usuario" placeholder="Ingrese usuario" required />
              <input type="password" name="clave" placeholder="Ingrese contraseña" required /> <button class="btn-mostrar" type="button" onclick="mostrarContrasena()">M</button>
              <button type="submit" class="botonlg" value="Iniciar Sesion"></button>
